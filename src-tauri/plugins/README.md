...
解决方案：新建`插件名/.tauri/tauri-api`文件夹，克隆[https://github.com/tauri-apps/tauri](https://github.com/tauri-apps/tauri)存储库，将`crates/tauri/mobile/ios-api`里面的所有内容复制到刚刚新建的文件夹中，Rebuild即可
